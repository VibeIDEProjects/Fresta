...
_HARV_PATH = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "harvest", "harvest_subscription.py"))
...
try:
    ...
    b64_no_marker = base64.b64encode("vless://abc@1.1.1.1:443?sni=test\n".encode()).decode()
...
print(f"OK: harvest() counts: {res['real']} real, "
